        ...
        <navigation-drawer>
                        ...
                        <v-row style="margin-top: 0px;">
                            <v-col cols="5">
                                <v-row>
                                    ...
                                    <v-col cols="8"><input v-model="custMangRequest.custInfo.custNm" type="text"
                                            required class="custom-input"></v-col>
                                </v-row>
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color: rgb(217, 217, 217);"><span>カナ</span></v-col>
                                    <v-col cols="8"><input v-model="custMangRequest.custInfo.custKn" type="text"
                                            class="custom-input"></v-col>
                                </v-row>
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>Webサイト</span></v-col>
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>電話番号</span></v-col>
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>FAX</span></v-col>
                            ...
                            <v-col cols="6">
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>資本金</span></v-col>
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>取引先種別</span></v-col>
                                    <v-col cols="8">
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>取引開始日</span></v-col>
                                    <v-col cols="8">
                                        <v-menu ref="menu" v-model="menu" :close-on-content-click="false"
                                            ...
                                            <template v-slot:activator="{ attrs }">
                                                <div class="d-flex align-center input-with-icon">
                                                    <input v-model="formattedDate" type="date" class="custom-input"
                                                        readonly @click="toggleMenu" v-bind="attrs" />
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>登録番号</span></v-col>
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>派遣資格</span></v-col>
                                ...
                                <v-row>
                                    <v-col cols="3"
                                        style="background-color:rgb(217, 217, 217);"><span>自社担当者</span></v-col>
            ...
            <div style="background-color:rgb(242, 242, 242) ;">
                <v-container fluid style="margin-left: 80px;">
                    <v-row style="height: 50px;margin-bottom: 15px;"><v-btn class="btn"
                            @click="addRow">行追加</v-btn></v-row>
                        ...
                        <v-col cols="5" style="margin: 0px;">
                            <v-row v-if="showGetRow">
                                ...
                                <v-col cols="2" style="padding-right: 0px;"><select
                                        v-model="custMangRequest.custInfo.custGetdt" id="getoptions"
                                        class="custom-select">
                                ...
                                <v-col cols="2">
                                    <div class="custom-input" v-if="showGet"
                                        style="width: 40px;text-align: center;margin-left: 0px;padding-left: 0px;">日
                                    </div>
                                </v-col>
                            </v-row>
                            <v-row v-if="showPayRow">
                                ...
                                <v-col cols="2" style="padding-right: 0px;"><select
                                        v-model="custMangRequest.custInfo.custPaydt" id="payoptions"
                                        class="custom-select">
                                        <option value="当月">当月</option>
                                        <option value="翌月">翌月</option>
                                        <option value="翌々月">翌々月</option>
                                ...
                                <v-col cols="2" style="padding-left: 0px;padding-right: 20px;"><input
                                        v-model="custMangRequest.custInfo.custOrderdt" class="custom-input"
                                        v-if="showPay">
                                </v-col>
                                <v-col cols="2">
                            ...
                            <v-row>
                                ...
                                <v-col cols="8">
                                    <div style="display: flex;align-items: center;"><input
                                        ...
                                        <v-btn v-if="showBankBtn" style="width: 40px;" class="btn"
                                            @click="openBank()">検索</v-btn>
                                    </div>
                            ...
                            <v-row>
                                ...
                                <v-col cols="8"><select v-model="custMangRequest.custInfo.custDeposittype"
                                        id="typeoptions" class="custom-select">
                        ...
                        <v-col cols="6">
                            <v-row>
                                <v-col cols="3" style="background-color:rgb(217, 217, 217);"><span>支店番号</span><span
                                        style="color:brown;font-size: 20px;">*</span></v-col>
                                <v-col cols="8"><input v-model="custMangRequest.custInfo.custBranchcd"
                                        class="custom-input" required></v-col>
                            </v-row>
                            <v-row>
                        ...
                        <v-col cols="5" style="margin: 0px;">
                            ...
                            <v-row>
                                ...
                                <v-col cols="8">
                                    <div style="display: flex;align-items: center;"><input
                                            v-model="custMangRequest.custInfo.custBankNm" class="custom-input" required>
                                        <v-btn v-if="showBankBtn2" style="width: 40px;" class="btn"
                                            @click="openBank()">検索</v-btn>
                                    </div>
                                    <v-dialog v-model="openBankDialog" max-width="1100">
                                        <v-card>
    ...
    data()  {
        return {
            custMangRequest: {
                ...
                mangInfo: [{ managerNm: '', managerPno: '', managerMail: '', managerJob: '', managerRmk: '', managerCrdUsr: '', managerUpdUsr: '', isNew: false, managerCustId: '' }],
            },
            banks: [],
            custBank: [],
            menu: false,
